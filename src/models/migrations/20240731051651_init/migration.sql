...
CREATE TABLE `Page` (
    ...
    `type` ENUM('Masters', 'Transactions', 'Reports', 'AdminAccess', 'Dashboard') NOT NULL,
...
CREATE TABLE `Customer` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `customerDetId` VARCHAR(191) NULL,
    ...
    `age` INTEGER NULL,
    `marriedStatus` VARCHAR(191) NULL,
    `companyId` INTEGER NOT NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `panNo` VARCHAR(191) NULL,
    `image` VARCHAR(191) NULL,
    `whatsNum` VARCHAR(191) NULL,
