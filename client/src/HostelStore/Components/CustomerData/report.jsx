...
const CustomerReport = () => {
    ...
    return (
        <div className="h-full flex bg-gray-100 w-full ">
            <div className="bg-white p-2 rounded shadow-md w-full">
                <div className='flex p-1 w-full  bg-sky-300 text-center  rounded-t text-[15px] justify-between'><h2 className="text-xl font-bold ">Customer Report</h2>
                    <input
                        type="text"
                            ...
                            {filteredCustomers.map((customer, index) => (
                                <React.Fragment key={customer.id}>
                                    ...
                                    >
                                        ...
                                        <td className='py-2 text-left border'>{customer.name}</td>
